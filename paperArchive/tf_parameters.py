...
# Author: Coco Gao
# Date: 2020/5/15 下午4:53
# Email: gaojh4@lenovo.com
# Description: Define tf parameters
...
# define for entrypoint
flags.DEFINE_string(
    "run", "ab",
    "entry point has parameters run.")
...
flags.DEFINE_bool('do_demo', False, 'whether to run demo.')
...
tf.flags.DEFINE_string(
    "train_file", None,
    "[Optional] train file for every models")

tf.flags.DEFINE_string(
    "eval_file", None,
    "[Optional] evaluation file for every models")
...
class DataProcessor(object):
    ...
    def get_batch_examples(self, texts):
        """Get one `InputExample` for prediction."""
        raise NotImplementedError()
